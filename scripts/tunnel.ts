...
async function main() {
  ...
  console.log(sep)
  console.log(`\n📥 Paste these UNIFIED URLs in your provider dashboards`)
  console.log(`   (one URL per provider, used for BOTH SMS and Voice):\n`)
  console.log(`   Twilio  →  ${httpsUrl}/api/webhooks/twilio`)
  console.log(`     • Phone Numbers → <number> → Messaging Webhook`)
  console.log(`     • Phone Numbers → <number> → Voice Webhook\n`)
  console.log(`   Telnyx  →  ${httpsUrl}/api/webhooks/telnyx`)
  console.log(`     • Messaging Profiles → <profile> → Inbound Webhook URL`)
  console.log(`     • Voice → Voice API & Apps → <app> → Webhook URL\n`)
  console.log(`   Signal House  →  ${httpsUrl}/api/webhooks/signalhouse  (stub)\n`)
  console.log(sep)
  console.log(`\n💡 Tips:`)
