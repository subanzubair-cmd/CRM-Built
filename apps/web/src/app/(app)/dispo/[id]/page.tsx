...
import { OfferComparisonCard } from '@/components/pipelines/OfferComparisonCard'
...
export default async function DispoDetailPage({ params }: PageProps) {
  ...
  const [commStatsMap, adjacentIds] = await Promise.all([
    ...
    getAdjacentPropertyIds(property.id, 'IN_DISPO'),
  ])
